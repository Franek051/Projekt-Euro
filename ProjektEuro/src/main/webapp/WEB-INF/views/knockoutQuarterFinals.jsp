...
<table border="1">
    ...
    <c:forEach var="match" items="${matches}">
        <tr>
            ...
            <td>
                <form action="${pageContext.request.contextPath}/api/knockout/simulate/quarter-finals/${match.id}" method="post">
...
<form action="${pageContext.request.contextPath}/api/knockout/setup-semi-finals" method="post">
    <button type="submit">Przejdź do 1/2 Finału</button>
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
</form>
