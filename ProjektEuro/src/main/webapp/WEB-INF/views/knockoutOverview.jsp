...
<html>
<head>
    <title>Lista Meczów Turnieju</title>
</head>
<body>
<h1>Lista Meczów Turnieju</h1>
<table border="1">
    <thead>
    <tr>
        <th>Mecz</th>
    ...
    <c:forEach var="match" items="${matches}">
        <tr>
            ...
            <td>
                <form action="${pageContext.request.contextPath}/api/knockout/simulate/${match.id}" method="post">
...
<form action="${pageContext.request.contextPath}/api/knockout/setup-quarter-finals" method="post">
    <button type="submit">Przejdź do 1/4 Finału</button>
    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
</form>
